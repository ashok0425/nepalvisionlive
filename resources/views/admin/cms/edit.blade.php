...
<div class=" col-md-6">
 ...
 <input name="keyword"   class='form-control' value=' {{ $menu->keyword }}' type='text' placeholder="Keyword">
</div>

<div class=" col-md-6">
	<label class="form-label"> Meta Title</label>
 <input name="meta_title"   class='form-control' value=' {{ $menu->meta_title }}' type='text' placeholder="Meta  Title">
</div>
