...
<x-errormsg/>
        <form action="{{route('admin.banners.update',$banner->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class=" col-md-6">
             ...
             <input name="title"   class='form-control' value=' {{ $banner->title }}' type='text' placeholder="Enter Banner Title">
            </div>
            <div class=" col-md-6">
                <label class="form-label">Banner Link</label>
             <input name="link"   class='form-control' value=' {{ $banner->link }}' type='url' placeholder="Enter Banner url">
            </div>
            <div class="col-md-6">
