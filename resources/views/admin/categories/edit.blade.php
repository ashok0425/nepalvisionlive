...
<div class="card">
    ...
    <x-errormsg/>
        ...
        <form action="{{ route('admin.categories-destinations.update',$category->id) }}" enctype="multipart/form-data" method="POST">
            @method('PATCH')
            @csrf
            <div class="row">
            <div class="form-group col-md-6">
                <label >Name</label>
           <input type="text" class="form-control" name="name" placeholder="Destination Name" value="{{ $category->name }}">
            </div>
           ...
           <input type="number" class="form-control" name="order" placeholder="Order number" value="{{ $category->order }}">
            ...
            <div class="form-group col-md-3 col-6 text-center">
                ...
                <p></p>
           <input type="checkbox" value="1"  name="quick_trip" @if ($category->quick_trips==1)
               checked
           @endif>
           ...
           <a href="{{ getimageUrl($category->image) }}" download="destination"  rel="noreferrer"  target="_blank">
           <img src="{{ getimageUrl($category->image) }}" alt="{{ getimageUrl($category->name) }}" width="100">
