...
">
                <img src="{{asset('frontend/assets/logo-trip 1.png')}}" alt="tripadviser" class="img-fluid w-50">
            </div>
            <div class="col-lg-3 col-md-6   px-lg-0 col-6 mt-sm-5 text-center mb-sm-2 my-lg-0
">
                <img src="{{asset('frontend/assets/logo-trustpilot 1.png')}}" alt="trustpilot" class="img-fluid w-50">

            </div>
            <div class="col-lg-3 col-md-6   px-lg-0 col-6 mt-sm-5 text-center mb-sm-2 my-lg-0
">
                <img src="{{asset('frontend/assets/stride.png')}}" alt="stride" class="img-fluid w-50">

            </div>
            <div class="col-lg-2 col-md-6   px-lg-0 col-6 text-center mt-xs-5 mb-xs-2 my-lg-0
">
                <img src="{{asset('frontend/assets/google-reviews 1.png')}}" alt="google-reviews" class="img-fluid w-75">

            </div>
            <div class="col-lg-2 col-md-6   px-lg-0 col-6 offset-3 offset-md-0 text-center mt-xs-5 mb-xs-2 my-lg-0
">
                <img src="{{asset('frontend/assets/logoyep.png')}}" alt="logoyep" class="img-fluid w-75">
