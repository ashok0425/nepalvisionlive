               ...
               <div class="card-header">
                ...
                <form action="{{ route('booking.step2.store') }}" method="POST">
                            ...
                            <div class="my-2 card-header custom-bg-primary text-light d-flex align-items-center">
                                <h3 class="custom-fs-18 custom-fw-600 d-flex align-items-center card-title">Personal Information Traveller {{ 1 }}</h3>
                            </div>
                            <div class="card-body">
                                ...
                                {{-- <form action="#"> --}}
                                    ...
                                    <div class="form-group row my-2">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="fname[]" placeholder="John" required name="f_name[]" required>
                                        </div>
                                    </div>
                                    <div class="form-group row my-2">
                                    ...
                                    <div class="form-group row my-2">
                                        <label for="expiryDate" class="col-md-4 custom-text-primary custom-fw-600 custom-fs-16 col-form-label ">Expiry date: </label>
                                        <div class="col-md-8">
                        ...
                        <h4 class="custom-text-primary ">Insurance</h4>
                                    ...
                                    <div class="">
                                        <label class="custom-text-primary custom-fs-16 line-height-0">
                                            <input class="" type="radio" name="insurance[1]" id="exampleRadios1" value="I have full coverage of Insurance" checked required> I have full coverage of Insurance (Copy must be provided up on your arrival in Kathmandu)
                                        </label>
                                    </div>
                                    <div class="">
                                        <label class="custom-text-primary custom-fs-16 line-height-0">
                                            <input class="" type="radio" name="insurance[1]" id="exampleRadios2" value="Not yet bought" required> Not yet bought (I will Choose insurance later)
                                        </label>
                                    </div>
                                </div>
...
<div class="card-body">
    ...
    <div class="want_tofill">
       <input type="checkbox" name="" id="other_info"> <label for="other_info" class="custom-fs-18"> &nbsp; Want to fill other guest info too.</label>
    </div>
</div>
