...
<div class="card-style-2">
    ...
    <div class="img-container">
        ...
        @else 
        <img src="{{ asset('frontend/product_image_thumbnail_placeholder.webp')}}" data-src="{{ getimageUrl($package->banner)}}" alt="{{$package->name  }}" class="img-fluid w-100 lazy" width="200" height="300">
        @endif
    </div>
